...
def parse_markdown(filepath):
    ...
    # 【大幅改良】縦横の最大サイズを適正に制限し、かつクリックで別タブ拡大可能にするカプセル化回路
    # ランドスケープは横500px、ポートレートは縦400pxをそれぞれ上限の閾値とする。
    img_replacement = (
        r'<a href="\2" target="_blank" title="クリックで拡大（別タブ）" style="display:inline-block; text-decoration:none;">'
        r'<img src="\2" alt="\1" style="max-width:500px; max-height:400px; width:auto; height:auto; '
